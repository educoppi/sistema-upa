...
interface Props {
  children: React.ReactNode; // qualquer conteúdo que for colocado dentro
}

export default function SegmentoCard({ children }: Props) {
  return (
    <div className={styles.segmentoCard}>
      {children}
    </div>
  );
}
